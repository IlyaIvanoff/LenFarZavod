...
namespace WindowsFormsApp1
{
    public partial class Form8 : Form
    {
        ...
        private void AddToCart_Click(object sender, EventArgs e)
        {
            ...
            if (!int.TryParse(NumberAstra.Text, out numberAstra) || !int.TryParse(KolvoAstra.Text, out kolvoAstra))
            {
            ...
            using (SqlConnection connection = new SqlConnection(connectionString))
            {
                ...
                using (SqlCommand command = new SqlCommand(query, connection))
                {
                    ...
                    command.Parameters.AddWithValue("@NumberBalet", numberAstra);
                    command.Parameters.AddWithValue("@KolvoBalet", kolvoAstra);
